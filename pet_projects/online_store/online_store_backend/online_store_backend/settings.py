...
INSTALLED_APPS = [
    ...
    'online_store_app.apps.OnlineStoreAppConfig',
    'online_store_api.apps.OnlineStoreApiConfig',
    'django_extensions',
]
...
LOGIN_URL = '/login/'
LOGIN_REDIRECT_URL = '/online_store/'
AUTH_USER_MODEL = 'accountss.OnlineStoreUser'
